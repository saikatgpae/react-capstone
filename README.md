...
# Covid tracker.
Description
This app display the state wise COVID infection informations of India.

## Built With

- Major languages HTML, CSS, JavaScript.
- Frameworks Bootstrap, React.
- Technologies used Bootstrap, linters, jest.
...
git clone https://github.com/saikatgpae/react-capstone.git
...
- Nelson Sakwa for the amazing on Behance design.
